...
const Login = () => {
        ...
        axios.post(`${process.env.REACT_APP_SERVIDOR}/api/usuarios`,body,{
           ...
           console.log(token)
            if((tokenAuth === 0)){
                ...
                cookies.set('token', '3d33c77f6aba01680fce7ec86557886856f6e75392fc3d7e79566fd0980b6c03',{ path: '/', maxAge: 2592000});
    ...
    return (
        <div>
            <div className="login">
                <div className="col-md-4 mx-auto text-white" style={{marginTop:'20%'}}>
                    ...
                    <form action="" onSubmit={loginHandler}>
                        ...
                        <button type="submit" className="btn mt-3">Iniciar Sesión</button>
                    </form>
                </div>
            </div>
        </div>
