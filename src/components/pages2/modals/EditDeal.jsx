        ...
        <div className="bg-white p-5 my-4">
          <div className="row">
            <div className="col-md-4">
              ...
              <input type="text" name="" id="" className="form-control" defaultValue={deal.closeProbability} />
            </div>
            <div className="col-md-4">
              <label htmlFor="">Deal Value</label>
              <input type="text" name="" id="" className="form-control" defaultValue={deal.dealValue} />
            </div>
            <div className="col-md-4">
              <label htmlFor="Deal Length">Deal Length</label>
              <input type="text" name="" id="" className="form-control" defaultValue={deal.dealLength} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-6">
              <label htmlFor="Expected Close Date">Expected Close Date</label>
              <input type="date" name="" id="" className="form-control" value={moment(deal.expectedCloseDate).format("YYYY-MM-DD")} />
            </div>
            <div className="col-md-6">
              <label htmlFor="Deal Creation Date">Deal Creation Date</label>
              <input type="date" name="" id="" className="form-control" value={moment(deal.dealCreationDate).format("YYYY-MM-DD")} />
            </div>
          </div>
        </div>
        <div className="bg-white p-5 my-4">
          <label htmlFor="Tareas">Tareas</label>
          <textarea name="" id="" cols="30" className="form-control" rows="5" defaultValue={deal.tasks}></textarea>
