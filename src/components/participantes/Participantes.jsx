...
const Participantes = () => {
  ...
  const getParticipantes = () => {
    axios
      .get(`${process.env.REACT_APP_SERVIDOR}/api/clientes?origen=si`, {
        headers: {
          token: "JaRvIs92!",
  ...
  return (
    <div className="bg-white my-5 p-2">
      ...
      <div className="my-5 text-center">
        ...
        <p>
          Los siguientes participantes son personas que ingresaron al formulario
          www.ccac.com.co/participantes y nos enviaron ya sus documentos
        </p>
      </div>
          ...
          <tbody>
            {participantes.map((i) => (
              <tr key={i.id}>
                ...
                <td>
                  <a
                    href={"https://www.ccac.com.co/storage/" + i.pasaporteFile}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Ver Pasaporte
                ...
                <td>
                  <a
                    href={"https://www.ccac.com.co/storage/" + i.vacunaFile}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Ver Vacuna
                ...
                <td>
                  <button
                    ...
                    onClick={() => updateParticipantes(i.id)}
                  >
